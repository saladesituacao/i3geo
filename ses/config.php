...
(function() {
	if(typeof ol != "undefined" && i3GEO.Interface.googleLike === false){
		...
		i3GEO.Interface.LAYERSADICIONAIS = [ mosaico_df_2015_SIRGAS_tms_layer, eng, oce, ims, wsm,
		                                                bra];
	}
	if(typeof ol != "undefined" && i3GEO.Interface.googleLike === true){
			...
			i3GEO.Interface.LAYERSADICIONAIS = [ mosaico_df_2015_SIRGAS_tms_layer, osm, aquarela, toner, tonerlite, layMapQuestAerial ];
	}
})();