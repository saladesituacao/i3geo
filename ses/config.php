...
(function() {
	if(typeof ol != "undefined" && i3GEO.Interface.openlayers.googleLike === false){
		...
		var wsm = new ol.layer.Tile(
				{
					...
					isBaseLayer : true,
					name : "wsm",
                    preview : "<img class='img-responsive img-thumbnail' src='https://server.arcgisonline.com/ArcGIS/rest/services/ESRI_StreetMap_World_2D/MapServer/export?F=image&FORMAT=PNG32&TRANSPARENT=true&SIZE=256,256&BBOX=-67.5,-22.5,-45,0&BBOXSR=4326&IMAGESR=4326&DPI=90' >",
					source : new ol.source.TileArcGISRest(
							{
								crossOrigin : "anonymous",
		...
		var bra = new ol.layer.Tile(
                ...
                var mosaico_df_2015_SIRGAS_tms_layer = new ol.layer.Tile(
                        {
                            title : "Mosaico DF 2015",
                            visible : false,
                            isBaseLayer : true,
                            name : "mosaico_df_2015_SIRGAS_tms_layer",
                            preview: "<img src='./codigo/ortofoto_mapa_codeplan_df_gov_br.php?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image%2Fpng&TRANSPARENT=true&layers=mosaico_df_2015&srs=EPSG%3A4674&format=image%2Fpng&WIDTH=256&HEIGHT=256&CRS=EPSG%3A4326&STYLES=&BBOX=-15.8038330078125%2C-47.867431640625%2C-15.79833984375%2C-47.8619384765625' >",
                            source : new ol.source.TileWMS(
                                    {
                                        crossOrigin : "anonymous",
                                        url : "http://ortofoto.mapa.codeplan.df.gov.br/wms",
                                        params : {
                                            'layers' : "mosaico_df_2015",
                                            'srs' : "EPSG:4674",
                                            'format' : "image/png"
                                        }
                                    })
		...
		i3GEO.Interface.openlayers.LAYERSADICIONAIS = [ mosaico_df_2015_SIRGAS_tms_layer, eng, oce, ims, wsm,
		                                                bra];
	}
	if(typeof ol != "undefined" && i3GEO.Interface.openlayers.googleLike === true){
                ...
                var mosaico_df_2015_SIRGAS_tms_layer = new ol.layer.Tile(
                        {
                            ...
                            name : "mosaico_df_2015_SIRGAS_tms_layer",
                            //preview: "<img src='./codigo/ortofoto_mapa_codeplan_df_gov_br.php?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image%2Fpng&TRANSPARENT=true&layers=mosaico_df_2015&srs=EPSG%3A4674&format=image%2Fpng&WIDTH=256&HEIGHT=256&CRS=EPSG%3A4326&STYLES=&BBOX=-15.8038330078125%2C-47.867431640625%2C-15.79833984375%2C-47.8619384765625' >",
                            preview: "<img src='http://ortofoto.mapa.codeplan.df.gov.br/wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image%2Fpng&TRANSPARENT=true&layers=mosaico_df_2015&srs=EPSG%3A4674&format=image%2Fpng&WIDTH=256&HEIGHT=256&CRS=EPSG%3A4326&STYLES=&BBOX=-15.8038330078125%2C-47.867431640625%2C-15.79833984375%2C-47.8619384765625' >",
                            source : new ol.source.TileWMS(
                                    {
                                        crossOrigin : "anonymous",
                                        //url : "./codigo/ortofoto_mapa_codeplan_df_gov_br.php",
                                        url : "http://ortofoto.mapa.codeplan.df.gov.br/wms?",
                                        params : {
                                            'layers' : "mosaico_df_2015",
                                            'srs' : "EPSG:3857",
			...
			i3GEO.Interface.openlayers.LAYERSADICIONAIS = [ mosaico_df_2015_SIRGAS_tms_layer, osm, aquarela, toner, tonerlite, layMapQuestAerial ];
	}
})();