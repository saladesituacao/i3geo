...
try
{
    $dbh = new PDO('pgsql:dbname=dbsalasituacao;user=postgres;password=postgres;host=localhost');
    $dbhw = new PDO('pgsql:dbname=dbsalasituacao;user=postgres;password=postgres;host=localhost');
    $dbhstage = new PDO('pgsql:dbname=stage;user=postgres;password=postgres;host=localhost');
}
