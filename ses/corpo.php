...
<body id="i3geo" style='background: white;'>
    ...
    <div class="formTop">
        <form style="width: 340px;" class="buscaUnidade noprint" name="buscaUnidade" action="#" onsubmit="return false;">
            <div class="typeahead__container">
                <div class="typeahead__field" style="font-size: 2rem">
                    <span class="typeahead__query"> <input id="buscaUnidade" name="" placeholder="Procurar por" autocomplete="off" type="search">
                    </span> <span class="typeahead__button hidden-xs hidden-sm">
                        <button>
    ...
    <div>
        <table>
            <tr>
                <td>
                    <h4 >i3Geo v7 - Software livre para cria&ccedil;&atilde;o de mapas
        ...
        <img class="img-thumbnail" src="../imagens/pspb.png" style="width:50px"><br>

        <h3 class="well">Secretaria de Estado de Sa&uacute;de do Distrito Federal</h3>
        <img class="img-thumbnail" src="http://repositorio.df.gov.br/novo_header/images/logo_gov_bsb.png" border="0" alt="Secretaria de Estado de Saúde do Distrito Federal" />
    </div>
</script>
