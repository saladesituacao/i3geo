...
i3GEO.listaDeFerramentas = {
	menu : [{
	    id : "analiseSES",
	    nome : "An&aacute;lises em sa&uacute;de",
	    descricao : ""
	},
	{
	    nome : $trad("s1"),
	...
	submenus : {
		...
		id : "fluxoSih",
		text : "Fluxo SIH",
		url : "javascript:open_fluxo()"
	    },{
		id : "timelinemap",
		text : "Evolu&ccedil;&atilde;o temporal e espacial dos agravos",
		url : "javascript:open_timelinemap()"
	    }],
	    "ajudaMenu" : [{
