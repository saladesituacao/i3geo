...
legenda - (opcional) mostra a legenda no corpo do mapa sim|nao
	...
	Ao ativar a legenda dentro do mapa, os seguintes parametros podem ser utilizados para controlar as caracter�sticas:
...
escala - (opcional) mostra a barra de escala no corpo do mapa sim|nao
	...
	Ao ativar a barra dentro do mapa, os seguintes parametros podem ser utilizados para controlar as caracter�sticas:

		escala_color - cor RGB dos trechos principais da barra. Exemplo: &escala_color=255,0,0

		escala_backgroundcolor - cor dos trechos secund�rios
...
grade - (opcional) mostra a grade de coordenadas no corpo do mapa sim|nao
	...
	Ao ativar a grade, os seguintes parametros podem ser utilizados para controlar as caracter�sticas:
...
//
//caso seja uma requisi��o WMS com format
//
$format = $_GET["format"];
