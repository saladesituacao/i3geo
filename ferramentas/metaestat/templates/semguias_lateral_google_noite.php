...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="banner">
	<tr>
		<td class="banner" style=text-align:left;background-color:rgb(248,248,248) >
			<img src="logos/<?php echo $dadosmapa["logoesquerdo"];?>" height="70">
		</td>
	</tr>
</table>
<table id='mst' summary="" style='display:none;' width=100% cellspacing='0'>
		...
		<td align="left" id=contemFerramentas style="vertical-align:top;width:300px;text-align:left;" >
			<div id='guia1obj' align="left" style="overflow:auto;">
				<div id="i3geoCartoParametros_corpo" style="left:5px;position:relative; top:10px; display:block; text-align:left; width:248px;" >
					...
					<input type="button" id="i3GEOcartoBotaoAdicionaCamada" value="Adicionar" class="paragrafo" style="width:200px;cursor:pointer;color:blue" />
				</div>
		...
		<td id="contemMenu" style="text-align:right;height:0px;border-width:0pt 0pt 1px;border-color:rgb(240,240,240)">
			...
			<tr>
					<td  class=verdeclaro id=contemImg >
						<div id=googlemapsdiv style="background-image:  url('../../../imagens/i3geo1bw.jpg');"></div>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td class=tdbranca >
			<table width=100% >
				<tr>
					<td class=tdbranca style="width:50%;"> <div id=escala style="text-align:right;display:inline-table" ></div></td>
					<td class=tdbranca style="width:50%;"> <div id=localizarxy style="text-align:left;font-size:10px;display:inline-table">Aguarde...</div></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr style="border:0px">
		<td colspan=3 id="barraInferior" style="background-image:  url('../../../imagens/rodape.png');height:10px"></td>
	</tr>
</table>
<table id="i3GEOlogoMarca" style='margin: 0px auto;box-shadow:0 1px 13px gray;border-radius:5px;'>
	<tr>
		<td><div id=versaoi3geo ></div><h2 style="font-size:10px;font-family: Verdana, Arial, Helvetica, sans-serif;">i3Geo - Software livre para cria��o de mapas interativos e geoprocessamento</h2><h3 style="font-size:10px;font-family: Verdana, Arial, Helvetica, sans-serif;">Baseado no Mapserver, � licenciado sob GPL e integra o Portal do Software P�blico Brasileiro</h3></td>
	</tr>
	<tr>
...
i3GEO.finalizaAPI = function(){
	$i("guia1obj").style.height = 20 + i3GEO.parametros.h+"px";
}
