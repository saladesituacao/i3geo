...
i3GEOF.gradepontos.dicionario = {
	'ajuda' : [ {
		...
		es : "La cuadr&iacute;cula est&aacute; formada por puntos espaciados seg&uacute;n los par&aacute;metros de x e y."
	} ],
	'ajuda2' : [ {
	...
	'espacamentoGrade' : [ {
		...
		en : "Grid spacing",
		es : "Espaciado de la cuadr&iacute;cula"
	} ],
	'grau' : [ {
		pt : "Grau",
		en : "Degree",
	...
	'numeroPontos' : [ {
		...
		es : "N&uacute;mero de puntos. Total m&aacute;ximo de 10.000"
	} ],
	'adicionaTema' : [ {
	...
	'msg' : [ {
		...
		es : "El n&uacute;mero de puntos no puede ser mayor a 10.000"
	} ],
	'projMercator' : [ {
